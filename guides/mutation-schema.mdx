...
## Overview[​](https://docs.apps.dapplets.org/docs/examples/examples-of-mutation-configurations#overview "Direct link to Overview")
...
## Applications[​](https://docs.apps.dapplets.org/docs/examples/examples-of-mutation-configurations#applications "Direct link to Applications")

The schema specifies the applications that utilize the mutation:

* **`$apps`:** `${REPL_ACCOUNT}/app/Multiversity`

### Target Conditions[​](https://docs.apps.dapplets.org/docs/examples/examples-of-mutation-configurations#target-conditions "Direct link to Target Conditions")
...
### Purpose[​](https://docs.apps.dapplets.org/docs/examples/examples-of-mutation-configurations#purpose "Direct link to Purpose")
...
## Conclusion[​](https://docs.apps.dapplets.org/docs/examples/examples-of-mutation-configurations#conclusion "Direct link to Conclusion")
