...
<img alt="Lifecycle Special Cases Light" class="block dark:hidden" src="/images/cycle-special-cases-light.png" />

<img alt="Lifecycle Special Cases Dark" class="hidden dark:block" src="/images/cycle-special-cases-dark.png" />
